...
public class EmpresaResource {
    ...
    @POST
    public Response cadastrar(@Valid CadastrarEmpresaDto dto) throws Exception {
    ...
    @PUT
    @Path("/{id}")
    public Response atualizar(@PathParam("id") int id, @Valid AtualizarEmpresaDto dto) throws Exception {
